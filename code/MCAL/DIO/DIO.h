 ...
 * @brief           Interface file for Digital Input Output (DIO) module for Atmega32 
...
typedef enum {
    ...
    DIO_PINS_PEDESTRIAN_LED_R,
    DIO_PINS_PEDESTRIAN_LED_Y,
    DIO_PINS_PEDESTRIAN_LED_G,

    /* BUTTONS  */
    DIO_PINS_PEDESTRIAN_BUTTON,
} DIO_PINS_t;
